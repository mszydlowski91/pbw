	...
	private class ImageListRenderer implements ListCellRenderer {
		...
		public Component getListCellRendererComponent(JList jlist,
			...
			if (cellHasFocus)
				...
				jpanel.setBorder(normBorder);
			/*
			 * if(isSelected && cellHasFocus) jpanel.setPreferredSize(new
			 * Dimension(0, 120)); else jpanel.setPreferredSize(new Dimension(0,
			 * 70));
			 */
			ImageDescription id = (ImageDescription) value;
			image.setIcon(id.imageIcon_scaled);
			text.setText(id.name + " (" + id.imageIcon.getIconWidth() + "x"
					+ id.imageIcon.getIconHeight() + " Pixel)");
